...
/**
 * Description：复制一列的数据到另一列
 * Created by luolinjie on 2018/3/17.
 */
public class copy_colum {
     ...
     * 研发组
     */
//    private static String url = "jdbc:mysql://10.0.12.189:3306/" + db_name + "?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&zeroDateTimeBehavior=convertToNull";
//    private static String user = "root";
//    private static String password = "centos";
    /**
     * 平台组
     */
    private static String url = "jdbc:mysql://192.168.16.103:3306/" + db_name + "?tinyInt1isBit=false&useUnicode=true&characterEncoding=utf-8&autoReconnect=true&failOverReadOnly=false&zeroDateTimeBehavior=convertToNull";
    private static String user = "root";
    ...
    public static void copyAllDBColumns(String db_name) throws Exception {
...
//                "ZHONGDIANQUYURENLIU_TJ_001"
        ...
        for (String tb_name : targetTables) {
            ...
            String src2 = "wd84";
            String target2 = "wd";
            int i2 = copyColumn(tb_name,src1 ,target1);
            System.out.println("更新" + tb_name+"."+src1 +" --> "+tb_name+"."+target1 + "--条数：---------  " + i2 + "  ------------");
            int i3 = copyColumn(tb_name,src2 ,target2);
            System.out.println("更新" + tb_name+"."+src2 +" --> "+tb_name+"."+target2 + "--条数：---------  " + i3 + "  ------------");
            count += i2;
            System.out.println("Total:" + count);
        }
    }

    public static int copyColumn(String BaseTable, String srcColumn, String targetColumn) throws Exception {
        String sql = "UPDATE " + BaseTable + " SET " + targetColumn + "=" + srcColumn;
