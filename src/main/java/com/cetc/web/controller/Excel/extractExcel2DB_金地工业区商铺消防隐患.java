 ...
 */
public class extractExcel2DB_金地工业区商铺消防隐患 {
    ...
    private static String AllColunms = "uuid,organization_name,address," +
            "owner_name,check_date,risks,review_date,review_risks,comments,create_time";
